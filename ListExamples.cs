...
namespace Openize.Words.Examples
{
    ...
    /// using the <a href="https://www.nuget.org/packages/Openize.Words">Openize.Words</a> library.
    /// </summary>
    /// <example>
    /// <code>
    ...
    public class ListExamples
    {
        ...
        /// <a href="https://www.nuget.org/packages/Openize.Words">Openize.Words</a>.
            ...
            string filename = "WordListParagraphs.docx")
        {
            try
            {
                // Create a document with multiple multilevel list paragraphs using Openize.Words (https://www.nuget.org/packages/Openize.Words)
