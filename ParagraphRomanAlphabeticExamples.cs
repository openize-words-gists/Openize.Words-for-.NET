...
namespace Openize.Words.Examples
{
    ...
    public class ParagraphRomanAlphabeticExamples
    {
            ...
            string filename = "WordParagraphsRomanAlphabetic.docx")
        {
            try
            {
                // Create a document with roman and alphabeitc paragraphs using Openize.Words (https://www.nuget.org/packages/Openize.Words)
                ...
                { Text = "This document is generated by Openize.Words." });
